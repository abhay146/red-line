...
//     const loginSection = this.querySelector("#loginSection");
//     const signupSection = this.querySelector("#signupSection");
...
//     // Switch Forms
//     this.querySelector("#showSignup").addEventListener("click", (e) => {
//       e.preventDefault();
//       loginSection.style.display = "none";
//       signupSection.style.display = "block";
//     });

//     this.querySelector("#showLogin").addEventListener("click", (e) => {
//       e.preventDefault();
...
//       // Backend API
//       /*
//       const res = await fetch("https://red-line.onrender.com/login",{
//           method:"POST",
//           headers:{
...
//     // Signup Submit
//     this.querySelector("#signupForm").addEventListener("submit", async (e) => {
//       e.preventDefault();

//       const data = {
//         name: this.querySelector("#signupName").value,
//         email: this.querySelector("#signupEmail").value,
//         password: this.querySelector("#signupPassword").value
//       };
...
//       // Backend API
//       /*
//       const res = await fetch("https://red-line.onrender.com/signup",{
//           method:"POST",
//           headers:{
//              "Content-Type":"application/json"
//           },
...
class SiteHeader extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const closeBtn =
    this.querySelector(".close-btn");



    const loginSection =
    this.querySelector(".login-section");


    const signupSection =
    this.querySelector(".signup-section");



    const showSignup =
    this.querySelector(".show-signup");


    const showLogin =
    this.querySelector(".show-login");



    const loginForm =
    this.querySelector(".login-form");


    const signupForm =
    this.querySelector(".signup-form");
    ...
    loginForm.onsubmit=(e)=>{
      ...
      let data={
        ...
        email:
        this.querySelector(".login-email").value,
    ...
    signupForm.onsubmit=(e)=>{
      ...
      let data={
        ...
        name:
        this.querySelector(".signup-name").value,


        email:
        this.querySelector(".signup-email").value,


        password:
        this.querySelector(".signup-password").value
